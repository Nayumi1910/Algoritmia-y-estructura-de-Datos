...
void construir(struct Lista & lista){
    ...
    lista.cola = nullptr;
    lista.mayores = nullptr;
    lista.medios = nullptr;
    lista.longitud = 0;
}
...
void imprime(const struct Lista & lista){
    ...
    if (esListaVacia(lista)){
        ...
        while(recorrido != nullptr){
            cout<<recorrido->elemento.fecha.dd<<"/"
                    <<recorrido->elemento.fecha.mm<<"/"
                    <<recorrido->elemento.fecha.aa<<"-"
                    <<recorrido->elemento.codigo<<", ";
            recorrido = recorrido->siguiente;
        }   
    }
    cout<<endl;
