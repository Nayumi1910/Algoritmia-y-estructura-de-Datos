...
struct Nodo * crearNodo(int tiempo, int numero, struct Nodo * siguiente){
...
void insertarAlInicio(struct Lista & tad, int tiempo, int numero) {
...
void insertarAlFinal(struct Lista & lista, int tiempo, int numero){
    struct Nodo * nuevoNodo = crearNodo(tiempo, numero, nullptr);
