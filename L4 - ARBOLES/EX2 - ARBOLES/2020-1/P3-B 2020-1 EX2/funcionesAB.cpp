...
struct NodoArbol * crearNuevoNodo(struct NodoArbol * izquierda, int elemento,
    ...
    strcpy(nuevo->escrito,pregunta);
    nuevo->valor=valor;
    return nuevo;
}

void plantarArbolBinario(struct ArbolBinario & arbol, struct NodoArbol * izquierda, 
                         int elemento,char *pregunta,int valor, struct NodoArbol * derecha) {
    
    struct NodoArbol * nuevoNodo = crearNuevoNodo(izquierda, elemento,pregunta,valor, derecha);
...
void plantarArbolBinario(struct NodoArbol *& raiz, 
                    ...
                    char *pregunta,int elemento, int valor,struct NodoArbol * derecha){
...
void plantarArbolBinario(struct ArbolBinario & arbol, struct ArbolBinario & arbolIzquierda, 
                         int elemento,char *pregunta,int valor, struct ArbolBinario & arbolDerecha) {
    struct NodoArbol * nuevoNodo = crearNuevoNodo(arbolIzquierda.raiz, elemento,pregunta,valor,
            arbolDerecha.raiz);
    arbol.raiz = nuevoNodo;
...
void imprimirNodo(struct NodoArbol * raiz){
    cout<<setw(5)<<raiz->elemento<<"-"<<raiz->escrito;
}
