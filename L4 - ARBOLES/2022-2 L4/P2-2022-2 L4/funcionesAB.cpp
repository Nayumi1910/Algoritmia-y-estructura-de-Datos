...
struct NodoArbol * crearNuevoNodo(struct NodoArbol * izquierda, int elemento,int cant,
...
void plantarArbolBinario(struct ArbolBinario & arbol, struct NodoArbol * izquierda, 
                         int elemento,int cant, struct NodoArbol * derecha) {
    
    struct NodoArbol * nuevoNodo = crearNuevoNodo(izquierda, elemento,cant, derecha);
...
void plantarArbolBinario(struct ArbolBinario & arbol, struct ArbolBinario & arbolIzquierda, 
                         int elemento,int cant, struct ArbolBinario & arbolDerecha) {
    struct NodoArbol * nuevoNodo = crearNuevoNodo(arbolIzquierda.raiz, elemento,cant,
            arbolDerecha.raiz);
    arbol.raiz = nuevoNodo;
...
void imprimirNodo(struct NodoArbol * raiz){
    cout<<setw(15)<<raiz->elemento<<"-"<<raiz->cant;
}
