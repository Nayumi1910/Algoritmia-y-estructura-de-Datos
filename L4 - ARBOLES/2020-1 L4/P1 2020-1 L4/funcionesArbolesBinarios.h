...
struct NodoArbol * crearNuevoNodoArbol(struct NodoArbol *, Elemento, 
                                                          struct NodoArbol *);
void plantarArbolBinario(struct ArbolBinario &, struct NodoArbol *, Elemento,
                                                       struct NodoArbol * );
void plantarArbolBinario(struct ArbolBinario &, struct ArbolBinario &, Elemento,
                                                struct ArbolBinario &);
Elemento raiz(struct NodoArbol * nodo);
