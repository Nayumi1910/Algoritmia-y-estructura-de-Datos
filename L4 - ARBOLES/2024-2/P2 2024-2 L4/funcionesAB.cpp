...
struct NodoArbol * crearNuevoNodo(struct NodoArbol * izquierda, int elemento,
        int cantidad, struct NodoArbol * derecha) {
...
void plantarArbolBinario(struct ArbolBinario & arbol, struct NodoArbol * izquierda, 
    ...
    struct NodoArbol * nuevoNodo = crearNuevoNodo(izquierda, elemento,cantidad, derecha);
...
void plantarArbolBinario(struct ArbolBinario & arbol, struct ArbolBinario & arbolIzquierda, 
                         int elemento, int cantidad, struct ArbolBinario & arbolDerecha) {
    struct NodoArbol * nuevoNodo = crearNuevoNodo(arbolIzquierda.raiz, elemento,cantidad,
            arbolDerecha.raiz);
    arbol.raiz = nuevoNodo;
...
void imprimirNodo(struct NodoArbol * raiz){
    cout<<setw(5)<<raiz->elemento<<"-"<<raiz->cantidad;
}
